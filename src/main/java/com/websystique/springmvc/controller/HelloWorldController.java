...
public class HelloWorldController {
     ...
     *
     */
    @RequestMapping(value="/Spring4MVCFormValidationExample", method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value="/Spring4MVCFormValidationExample", method = RequestMethod.POST)
